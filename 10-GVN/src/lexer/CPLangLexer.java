...
public class CPLangLexer extends Lexer {
	...
	public CPLangLexer(final CharStream input) {
		super(input);
	...
	public void action(final RuleContext _localctx, final int ruleIndex, final int actionIndex) {
		...
		case 16:
			...
			break;
		case 33:
			this.BLOCK_COMMENT_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void BLOCK_COMMENT_action(final RuleContext _localctx, final int actionIndex) {
		switch (actionIndex) {
		case 1:
